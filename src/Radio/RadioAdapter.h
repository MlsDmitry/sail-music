...
struct feedback_t
{
    ...
    feedback_t(std::string station, std::string type,
               //            std::string from,
    ...
    {
        io &json_dto::mandatory("station", _station) & json_dto::mandatory("type", _type) &
...
QVariantList parseTracks(QJsonValue &data);
