...
void
TrackService::requestDownloadInfo(QString id)
{
    ...
    connect(_transport, &ApiRequest::dataReady, this, [=](QJsonValue& data) {
        emit trackDownloadInfoReady(data);
    }, Qt::UniqueConnection);
}

void
TrackService::requestFileDownloadInfo(QString downloadInfoUrl)
{
    ...
    connect(_transport, &ApiRequest::thirdPartyDataReady, this, [=](QNetworkReply* reply) {
